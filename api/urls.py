...
urlpatterns = [
    ...
    path('stripe/create_payment/' , views.stripe_create_payment , name='create_payment'),
    path('get_keys' , views.get_keys , name='get_keys'),
    path('saleApi' , views.saleApi , name='saleApi'),
    path('get_services_by_name_api/<str:name>' , views.get_services_by_name_api , name='get_services_by_name_api'),
